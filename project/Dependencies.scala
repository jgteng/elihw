...
//    "Typesafe Repository" at "http://repo.typesafe.com/typesafe/releases/"
  ...
  lazy val whale_common = "com.jd.bdp" % "whale-common" % "1.0-SNAPSHOT" exclude("org.slf4j", "slf4j-log4j12") exclude("log4j", "log4j")
  lazy val whale_communication = "com.jd.bdp" % "whale-communication" % "1.0-SNAPSHOT" exclude("org.slf4j", "slf4j-log4j12") exclude("log4j", "log4j")
...
//  lazy val slf4j_log4j12 = "org.slf4j" % "slf4j-log4j12" % "1.7.2"
  ...
  lazy val scala_mock = "org.scalamock" % "scalamock-core_2.10" % "3.1.RC1" exclude("org.specs2", "specs2_2.10")
  lazy val scala_mock_scalatest_support = "org.scalamock" % "scalamock-scalatest-support_2.10" % "3.1.RC1"
}